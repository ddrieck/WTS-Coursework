...
if (isset($_REQUEST['age'])) {
	...
	if ($age == '0-29') {
		$age_greeting = '<p><b>So you are either the most amazing toddler ever, or 29.</b></p>';
	} elseif ($age == '30-60') {
		$age_greeting = '<p><b>30-60 is a good age. Very wise.</b></p>';
	}	elseif ($age == '60+') {
		$age_greeting = '<p><b>Well done, using a computer at your age!</b></p>';
	} else { // Unacceptable value.
		$age = NULL;
		echo '<p class="error">Please select an age.</p>';
	}
